...
clear;clear;clear
  ...
  # // Banner
echo -e "${BLUE}----------------------------------------------------------${NC}"
echo -e " WELCOME TO SANAK STORE SCRIPT ${BLUE}(${NC}${green}Stable Edition${NC}${BLUE})${NC}"
echo -e " PROSES PENGECEKAN IP ADDRESS ANDA !!"
echo -e "${purple}----------------------------------------------------------${NC}"
echo -e " ›AUTHOR : ${green} SANAK STORE ® ${NC}${BLUE}(${NC}${green}V 0.0${NC}${BLUE})${NC}"
echo -e " ›TEAM : SANAK STORE ${BLUE}(${NC} 2024 ${BLUE})${NC}"
echo -e "${BLUE}----------------------------------------------------------${NC}"
echo ""
sleep 2
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/sanakstore1/VVIP/main/"
...
clear
izinsc="https://raw.githubusercontent.com/kuhingg/ip/main/vps"
# USERNAME
rm -f /usr/bin/user
